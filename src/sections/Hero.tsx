...
export const HeroSection = () => {
  return <div className='py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip'>
    ...
    <HeroOrbit size={650} rotation={180}>
      <div className="size-2 rounded-full bg-emerald-300/20" />
    </HeroOrbit>
    ...
    <div className="container">
      ...
      <div className='max-w-lg mx-auto'>
        <h1 className='font-serif text-3xl md:text-5xl text-center mt-8 tracking-wide'>Innovations in Game Development & Finance w/ AI</h1>
        <p className='mt-4 text-center text-white/60 md:text-lg'>I am a multidisciplinary professional, who thrives at the intersection of technology, finance, and innovation-an AI Engineer, Game Developer, and Financial Analyst 
