            ...
            <div className="lg:grid lg:grid-cols-2 lg:gap-16">
              ...
              <div className="relative">
                <Image
                    ...
                    className="mt-8 -mb-5 md:-mb-0 lg:mt-0 lg:absolute lg:h-full lg:w-auto lg:max-w-none"
                  />
              </div>
            </div>
          </div>
